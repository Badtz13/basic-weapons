...
public class BWItems {
  ...
  public static void init() {
    ...
    items.add(new ItemInfo("club", "stone_club",
        () -> new ClubItem(ToolMaterials.STONE, clubDamage, clubSpeed, new Item.Settings())));
    items.add(new ItemInfo("club", "iron_club",
        () -> new ClubItem(ToolMaterials.IRON, clubDamage, clubSpeed, new Item.Settings())));
    items.add(new ItemInfo("club", "golden_club",
        () -> new ClubItem(ToolMaterials.GOLD, clubDamage, clubSpeed, new Item.Settings())));
    items.add(new ItemInfo("club", "bonesteel_club",
        () -> new ClubItem(ToolMaterials.DIAMOND, clubDamage, clubSpeed, new Item.Settings())));
    /* Spears */
    ...
    items.add(new ItemInfo("quarterstaff", "wooden_quarterstaff",
        () -> new QuarterstaffItem(ToolMaterials.WOOD, quarterstaffDamage, quarterstaffSpeed, new Item.Settings())));
    items.add(new ItemInfo("quarterstaff", "stone_quarterstaff",
        () -> new QuarterstaffItem(ToolMaterials.STONE, quarterstaffDamage, quarterstaffSpeed, new Item.Settings())));
    items.add(new ItemInfo("quarterstaff", "iron_quarterstaff",
        () -> new QuarterstaffItem(ToolMaterials.IRON, quarterstaffDamage, quarterstaffSpeed, new Item.Settings())));
    items.add(new ItemInfo("quarterstaff", "golden_quarterstaff",
        () -> new QuarterstaffItem(ToolMaterials.GOLD, quarterstaffDamage, quarterstaffSpeed, new Item.Settings())));
    items.add(new ItemInfo("quarterstaff", "bonesteel_quarterstaff",
        () -> new QuarterstaffItem(ToolMaterials.DIAMOND, quarterstaffDamage, quarterstaffSpeed, new Item.Settings())));
